...
const claudeHookAdditions = [
    "Shatter their status quo with an inconvenient truth bomb.",
    "Start with the disaster everyone fears but nobody discusses.",
    "Challenge their most cherished belief with brutal honesty.",
    "Name the invisible force destroying their progress daily.",
    "Flip their industry's golden rule on its head.",
    "Make them question the habit they swear by.",
    "Drop the shocking stat that makes their strategy obsolete.",
    "Expose the lie they've built their entire approach around.",
    "Declare the end of an era they're still investing in.",
    "Share the weird trick your competitors would hate revealed.",
    "Open with the taboo question everyone avoids asking.",
    "Paint the future where their current path leads to ruin.",
    "Reveal what the industry giants desperately hide from beginners.",
    "Start with the counterintuitive secret that changed everything.",
    "Challenge their deepest fear with a 'what if' scenario.",
    "Show the hidden cost of their 'free' solution.",
    "Name the silent killer of their ambitious goals.",
    "Expose the myth costing them thousands in wasted effort.",
    "Begin with the uncomfortable truth veterans never share.",
    "Reveal the pattern keeping them stuck in mediocrity.",
    "Show the embarrassing mistake experts keep making.",
    "Ask the question that exposes their strategy's fatal flaw.",
    "Reveal the opportunity hidden in plain sight for years.",
    "Smash their expectations with an absurd yet true claim.",
    "Start with the paradox that's killing their progress.",
    "Tell them exactly what they're doing wrong, boldly.",
    "Open with the insider secret your mentor never shared.",
    "Begin with the terrifying future trend no one's prepared for.",
    "Call out the invisible problem they don't know they have.",
    "Start with the bizarre discovery that flips conventional wisdom.",
    "Challenge the sacred cow everyone worships in your field.",
    "Paint the scenario where they lose everything by playing safe.",
    "Open with the question that kept you awake last night.",
    "Start with the moment everything you knew became useless.",
    "Pose the multi-million dollar question nobody's asking.",
    "Drop a prediction that’ll make them rethink everything.",
    "Expose the flaw in their ‘foolproof’ plan.",
    "Start with a confession that’ll make them lean in.",
    "Reveal the statistic that proves they’re wasting time.",
    "Call out the trend they’re chasing that’s already dead.",
    "Open with a ‘you’re not crazy’ moment they’ll feel.",
    "Name the enemy they don’t even know they’re fighting.",
    "Start with the failure that taught you everything.",
    "Challenge them to rethink the tool they rely on.",
    "Drop a truth so raw they’ll have to face it.",
    "Expose the gap between what they think and what’s real.",
    "Begin with the ‘why’ they’ve never dared to ask.",
    "Reveal the shift that’s already rewriting their rules.",
    "Start with a ‘what if’ that feels like a punch.",
    "Call out the excuse they’ve been hiding behind."
];

const claudeStoryAdditions = [
    "Share the day you realized you’d been lied to.",
    "Tell the moment you hit rock bottom and clawed back.",
    "Relive the argument that forced you to rethink everything.",
    "Paint the time you trusted the wrong advice and paid.",
    "Reveal the failure you hid from everyone but learned from.",
    "Spill the night you stayed up solving the impossible.",
    "Tell the story of the mentor who betrayed your trust.",
    "Share the gamble you took that almost ruined you.",
    "Relive the moment you saw through the industry’s BS.",
    "Paint the scene where you lost it all and started over.",
    "Reveal the conversation that flipped your perspective.",
    "Tell the time you ignored your gut and regretted it.",
    "Spill the mistake you made that others still repeat.",
    "Share the day you walked away from a ‘sure thing.’",
    "Relive the hustle that broke you before it built you.",
    "Paint the chaos of the project that changed your life.",
    "Reveal the rejection that fueled your comeback.",
    "Tell the moment you realized you were the problem.",
    "Spill the truth about the win you didn’t deserve.",
    "Share the grind that taught you what books couldn’t.",
    "Relive the day you proved the doubters wrong.",
    "Paint the mess you made by following the crowd.",
    "Reveal the pivot you made when the plan imploded.",
    "Tell the story of the loss that became your strength.",
    "Spill the secret you uncovered after years of searching.",
    "Share the fight you didn’t want but had to win.",
    "Relive the breakthrough that came from pure desperation.",
    "Paint the moment you saw the future and ran toward it.",
    "Reveal the sacrifice you made that no one noticed.",
    "Tell the time you bet on yourself and shocked everyone.",
    "Spill the doubt that almost stopped you cold.",
    "Share the crash that forced you to rethink success.",
    "Relive the day you found the answer in the wreckage.",
    "Paint the scene where you defied the odds alone.",
    "Reveal the lesson you learned from a rival’s win.",
    "Tell the moment you stopped chasing someone else’s dream.",
    "Spill the truth about the ‘expert’ who got it wrong.",
    "Share the struggle you turned into a superpower.",
    "Relive the choice that split your life in two.",
    "Paint the failure that became your secret weapon.",
    "Reveal the risk you took that others called crazy.",
    "Tell the day you burned the playbook and won.",
    "Spill the fear you faced that no one else saw.",
    "Share the win you scratched out from nothing.",
    "Relive the moment you realized time was running out.",
    "Paint the grind you endured that others quit.",
    "Reveal the truth you found in the chaos.",
    "Tell the story of the wall you hit and broke through.",
    "Spill the mistake that turned into your big break.",
    "Share the day you decided to rewrite the rules."
];

const claudeLessonAdditions = [
    "Boil it down to the one truth they’re avoiding.",
    "Reveal the hidden pattern that explains their failures.",
    "Drop the realization that flipped your results.",
    "Show them the lie they’ve been living too long.",
    "Cut through the noise with a single sharp insight.",
    "Point out the flaw they’ve mistaken for strength.",
    "Strip it to the lesson that saved your ass.",
    "Flip their biggest excuse into a power move.",
    "Expose the trap they keep falling into.",
    "Hit them with the ‘aha’ that changed your game.",
    "Bare the truth they’re too scared to face.",
    "Show the root cause they’ve never questioned.",
    "Drop a lesson so raw it stings to hear.",
    "Reveal the shift that turns chaos into clarity.",
    "Cut to the core of what’s holding them back.",
    "Point to the gold they’ve been walking past.",
    "Smash the illusion they’ve built their life on.",
    "Flip their fear into a tool they can use.",
    "Strip away the myth that’s wasting their time.",
    "Hit them with a truth they can’t ignore.",
    "Show the mistake they’re repeating every day.",
    "Drop a gem that rewires how they think.",
    "Reveal the catch they’ve missed in their plan.",
    "Cut through the excuses they’ve stacked up.",
    "Point out the gap between effort and impact.",
    "Bare the lesson they’ll wish they learned sooner.",
    "Flip their ‘can’t’ into a ‘here’s how.’",
    "Expose the belief that’s silently killing them.",
    "Hit them with the insight that unlocks everything.",
    "Show the thread connecting their biggest wins.",
    "Drop a truth that forces them to rethink.",
    "Reveal the habit they need to kill today.",
    "Cut to the lesson that turns pain into power.",
    "Point to the lie they’ve let define them.",
    "Smash the rule they follow that’s breaking them.",
    "Flip their doubt into a reason to act.",
    "Strip it to the one thing they must know.",
    "Hit them with a realization that sticks forever.",
    "Show the blind spot they’ve ignored too long.",
    "Drop a lesson that cuts through the clutter.",
    "Reveal the tweak that makes all the difference.",
    "Cut away the noise they’re drowning in.",
    "Point out the strength they’ve buried deep.",
    "Bare the truth that turns failure into fuel.",
    "Flip their struggle into a simple fix.",
    "Expose the myth they’ve bet everything on.",
    "Hit them with a lesson they can’t unhear.",
    "Show the pivot that turns losses into wins.",
    "Drop a truth that shatters their old ways.",
    "Reveal the key they’ve had all along."
];

const claudeActionAdditions = [
    "Tell them to ditch one tool today.",
    "Give them a 30-second fix to try now.",
    "Point to a habit they can break tonight.",
    "Drop a tweak they can test this week.",
    "Show them one move to flip the script.",
    "Hand them a step they can take before bed.",
    "Make it a no-risk play they can run.",
    "Reveal a shortcut they can steal fast.",
    "Push them to ask one bold question.",
    "Give them a hack to cut the chaos.",
    "Tell them to stop one thing immediately.",
    "Point to a switch they can flip today.",
    "Drop a trick they can use by lunch.",
    "Show a play they can pull off solo.",
    "Hand them a fix that takes one call.",
    "Make it a step they can’t screw up.",
    "Reveal a tweak that doubles their edge.",
    "Push them to ditch the plan that’s dead.",
    "Give them a move that sparks results.",
    "Tell them to kill one excuse now.",
    "Point to a tool they can grab free.",
    "Drop a hack they can test in minutes.",
    "Show a step that shifts their game.",
    "Hand them a play they can win with.",
    "Make it a fix they can feel fast.",
    "Reveal a trick that saves them hours.",
    "Push them to rethink one choice today.",
    "Give them a tweak that turns heads.",
    "Tell them to cut one distraction out.",
    "Point to a move they can make alone.",
    "Drop a step that’s too easy to skip.",
    "Show a hack that flips their day.",
    "Hand them a fix they can own now.",
    "Make it a play they can nail quick.",
    "Reveal a tweak that’s pure gold.",
    "Push them to try one thing different.",
    "Give them a trick that’s stupid simple.",
    "Tell them to drop one myth today.",
    "Point to a step that breaks the rut.",
    "Drop a move they can pull tonight.",
    "Show a fix that cuts the noise.",
    "Hand them a hack that hits hard.",
    "Make it a tweak they can’t ignore.",
    "Reveal a play that changes everything.",
    "Push them to kill one fear now.",
    "Give them a step that’s raw power.",
    "Tell them to test one idea fast.",
    "Point to a trick they’ve overlooked.",
    "Drop a fix that’s ready to roll.",
    "Show them a move that wins big."
];

// New 'you' category
const claudeYou = [
    "Tell them they’re stronger than they think.",
    "Remind them they’ve survived worse before.",
    "Show them they’re the answer they need.",
    "Point out they’re closer than they realize.",
    "Push them to trust their own gut.",
    "Reveal they’ve got the edge already.",
    "Make them see they’re not alone here.",
    "Tell them they’re ready for this fight.",
    "Show them they’re the spark that’s missing.",
    "Remind them they’ve beaten odds like this.",
    "Point to the power they’ve buried deep.",
    "Push them to own their next move.",
    "Reveal they’re tougher than their doubts.",
    "Make them feel they’ve got this now.",
    "Tell them they’re the game-changer here.",
    "Show them they’re one step from winning.",
    "Remind them they’ve got grit to spare.",
    "Point out they’re the key to unlock it.",
    "Push them to see their own fire.",
    "Reveal they’re built for this moment.",
    "Make them believe they’re enough today.",
    "Tell them they’ve got the fight inside.",
    "Show them they’re the shift that matters.",
    "Remind them they’ve turned worse around.",
    "Point to the strength they’ve ignored.",
    "Push them to claim their own win.",
    "Reveal they’re the one who’ll break through.",
    "Make them feel they’re unstoppable now.",
    "Tell them they’ve got the guts to go.",
    "Show them they’re the fix they seek.",
    "Remind them they’ve outlasted the chaos.",
    "Point out they’re the twist that works.",
    "Push them to trust their own spark.",
    "Reveal they’re the edge they’ve missed.",
    "Make them see they’re ready to roll.",
    "Tell them they’ve got the truth within.",
    "Show them they’re the power to shift.",
    "Remind them they’ve crushed it before.",
    "Point to the fire they’ve kept alive.",
    "Push them to own their raw strength.",
    "Reveal they’re the one who’ll rewrite it.",
    "Make them feel they’ve got the juice.",
    "Tell them they’re the breakout star.",
    "Show them they’re the answer that fits.",
    "Remind them they’ve got scars that prove it.",
    "Point out they’re the push that wins.",
    "Push them to see their own gold.",
    "Reveal they’re the force that flips it.",
    "Make them believe they’re the real deal.",
    "Tell them they’ve got this in them."
];
    ],
    story: [
